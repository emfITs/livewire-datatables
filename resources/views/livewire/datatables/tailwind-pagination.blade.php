<div class="flex overflow-hidden border border-gray-300 divide-x divide-gray-300 rounded pagination">
    ...
    <button type="button" class="relative inline-flex items-center px-2 py-2 text-sm font-medium leading-5 text-gray-500 bg-white"
        disabled>
        <span>&laquo;</span>
    </button>
    @else
    ...
    <div class="divide-x divide-gray-300">
        ...
        <button type="button" class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-gray-700 bg-white" disabled>
            <span>{{ $element }}</span>
        </button>
        @endif
